...
class V2BookView(APIView):
    ...
    def patch(self, request, *args, **kwargs):
        ...
        book_ser = serializers.V2BookModelSerializers(instance=objs, data=new_request_data, partial=True, many=True, context={'request': request})
        book_ser.is_valid(raise_exception=True)
        ...
        # })
        book_objs_data = serializers.V2BookModelSerializers(book_objs, many=True).data
        return APIResponse(results=book_objs_data, data_msg='修改成功')
